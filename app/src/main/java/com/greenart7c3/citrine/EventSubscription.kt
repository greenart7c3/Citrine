...
object EventSubscription {
    suspend fun subscribe(subscriptionId: String, filter: EventFilter, session: DefaultWebSocketServerSession, context: Context, objectMapper: ObjectMapper, isLast: Boolean) {
